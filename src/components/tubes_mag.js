...
import DO_alto from '../suoni puliti/DO_maggiore_alto.mp3';
import DO_RE from '../suoni puliti/DO-RE-alto.mp3';
import RE from '../suoni puliti/RE_alto.mp3';
import RE_MI from '../suoni puliti/RE_MI_alto.mp3';
import MI from '../suoni puliti/MI_alto.mp3';
import FA from '../suoni puliti/FA_alto.mp3';
import FA_SOL from '../suoni puliti/FA_SOL_alto.mp3';
import SOL from '../suoni puliti/SOL_alto.mp3';
import SOL_LA from '../suoni puliti/SOL_LA_alto.mp3';
import LA from '../suoni puliti/LA_alto.mp3';
import LA_SI from '../suoni puliti/LA_SI_alto.mp3';
import SI from '../suoni puliti/SI_alto.mp3';
import DO_basso from '../suoni puliti/DO-maggiore-basso.mp3';

export default class TubesMag extends React.Component {
